...
- [ ] **Documentation updates** – Confirm `README.md`, `docs/README.md`, `USER_MANUAL.md`, and any operator runbooks reflect the upcoming release behavior. Remove or revise stale references.
...
- [ ] **MIT license compliance** – Verify `LICENSE` still matches the MIT template and that derivative work retains MIT headers where applicable.
